...
export function Gallery() {
  ...
  return (
    <div className="p-6 h-full flex flex-col pb-32 md:pb-6 overflow-y-auto bg-[#0A0A0A] text-white">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-2">
          <Button
            ...
            variant="ghost"
            className={`p-2 rounded-xl flex items-center gap-2 transition-all h-10 ${viewMode === 'cloud' ? 'bg-[#a855f7] text-white hover:bg-[#a855f7]' : 'bg-[#1A1A1A] text-gray-400 hover:bg-[#2A2A2A]'}`}
          >
            <Cloud size={20} />
          ...
          <Button
            ...
            variant="ghost"
            className={`p-2 rounded-xl flex items-center gap-2 transition-all h-10 ${viewMode === 'device' ? 'bg-[#a855f7] text-white hover:bg-[#a855f7]' : 'bg-[#1A1A1A] text-gray-400 hover:bg-[#2A2A2A]'}`}
          >
            <HardDrive size={20} />
      ...
      <div className="relative mb-6">
        ...
        <Input
          ...
          className="h-auto w-full bg-[#1A1A1A] border border-white/10 rounded-xl py-3 pl-12 pr-4 text-white focus:border-[#a855f7]"
        />
      </div>
      ...
      {viewMode === 'device' && localFolders.length === 0 && (
        <div className="flex flex-col items-center justify-center py-12 px-6 bg-[#1A1A1A] rounded-3xl border border-dashed border-white/10 mb-6">
          ...
          <Button
            ...
            className="bg-[#a855f7] text-white px-6 py-3 rounded-2xl font-bold flex items-center gap-2 hover:opacity-90 hover:bg-[#a855f7] transition-opacity"
          >
            <Plus size={20} />
            Select Folder
          </Button>
        ...
        {selectedPhoto && (
          <DialogContent className="bg-[#1A1A1A] w-full max-w-lg rounded-3xl overflow-hidden border border-white/10 flex flex-col max-h-[90vh] p-0 gap-0 text-white">
            ...
            <div className="p-6 space-y-6 overflow-y-auto">
              <DialogHeader>
                <DialogTitle className="text-xl font-bold mb-1">{selectedPhoto.nameCluster || 'Uncategorized Media'}</DialogTitle>
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  variant="outline"
                  className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 p-0"
                >
                  <Download size={18} />
                </Button>
                {canDelete(selectedPhoto) && (
                  <Button
                    ...
                    variant="outline"
                    className="w-10 h-10 rounded-full bg-red-500/10 border border-red-500/20 text-red-500 flex items-center justify-center hover:bg-red-500/20 p-0 hover:text-red-500"
                  >
                    <Trash2 size={18} />
                  </Button>
                )}
