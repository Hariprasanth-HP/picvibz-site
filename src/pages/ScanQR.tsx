      ...
      <div className="px-6 flex-1 flex flex-col md:max-w-2xl md:mx-auto md:w-full">
        ...
        <div className="relative mb-6">
          <Input
            ...
            className="h-auto w-full bg-white dark:bg-[#1A1A1A] text-gray-900 dark:text-white border border-gray-200 dark:border-transparent rounded-2xl py-4 px-5 pr-12 outline-none focus:ring-2 focus:ring-[#a855f7]/50 transition-all font-medium placeholder:text-gray-400 dark:placeholder:text-gray-500 shadow-sm"
          />
        ...
        <Button
          ...
          className="w-full bg-gradient-to-r from-[#6366f1] to-[#22d3ee] text-white font-bold rounded-full py-4 flex items-center justify-center gap-2 mb-8 shadow-[0_0_30px_rgba(99,102,241,0.3)] hover:opacity-90 hover:from-[#6366f1] hover:to-[#22d3ee] h-auto disabled:opacity-50"
        >
