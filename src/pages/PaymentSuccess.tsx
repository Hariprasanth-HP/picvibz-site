...
export function PaymentSuccess() {
  ...
  const { setEventPasses, eventPasses } = useAppContext();
    ...
    <div className="h-full flex flex-col bg-gray-50 dark:bg-[#0A0A0A] overflow-y-auto pb-24 md:pb-12 relative text-gray-900 dark:text-white transition-colors duration-300">
      ...
      <div className="p-6 flex-1 flex flex-col items-center justify-center relative z-10 md:max-w-2xl md:mx-auto md:w-full">
        ...
        <div className="w-full mt-auto">
          <Button
            onClick={() => navigate('/')}
            className="w-full bg-gradient-to-r from-[#8b5cf6] to-[#d946ef] rounded-xl py-4 font-bold text-lg text-white shadow-[0_0_20px_rgba(139,92,246,0.3)] mb-4 hover:opacity-90 hover:from-[#8b5cf6] hover:to-[#d946ef] h-auto"
          >
            Back to Home
          </Button>
          <Button
            variant="ghost"
            className="w-full py-4 font-bold text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white h-auto"
          >
            View Receipt
          </Button>
        </div>
