import { Settings, LogOut, ChevronRight, CreditCard, Smartphone, Shield, Gift } from 'lucide-react';
  ...
  return (
    <div className="p-6 h-full flex flex-col pb-32 md:pb-6 overflow-y-auto bg-[#0A0A0A] text-white">
      <div className="flex items-center justify-between mb-8">
        ...
        <Button variant="ghost" className="p-2 rounded-full bg-[#1A1A1A] text-gray-400 hover:text-white h-10 w-10 hover:bg-[#2A2A2A]">
          <Settings size={24} />
        </Button>
      </div>
      ...
      <div className="space-y-6">
        ...
        <Button
          onClick={logout}
          variant="outline"
          className="w-full bg-[#1A1A1A] border border-red-500/20 rounded-2xl p-4 flex items-center justify-center gap-2 text-red-400 font-bold hover:bg-red-500/10 hover:text-red-400 hover:border-red-500/30 mt-8 h-auto"
        >
          <LogOut size={20} />
          Log Out
        </Button>
