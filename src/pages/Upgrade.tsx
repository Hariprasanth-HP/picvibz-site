      ...
      <div className="p-6 md:max-w-2xl md:mx-auto md:w-full">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl p-6 border border-gray-200 dark:border-white/5 bg-gray-50 dark:bg-[#1A1A1A]/50 transition-colors">
            ...
            <Button
              onClick={() => navigate('/payment', { state: { amount: 499, eventName: 'Single Pass' } })}
              variant="outline"
              className="w-full bg-white dark:bg-[#2A2A2A] border border-gray-200 dark:border-white/10 rounded-xl py-3 font-bold text-sm text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-white/5 h-auto"
            >
              Buy 1 Pass
            </Button>
          </div>
          ...
          <div className="rounded-2xl p-6 border-2 border-[#a855f7] bg-purple-50 dark:bg-[#a855f7]/10 shadow-md relative transition-all">
            ...
            <Button
              onClick={() => navigate('/payment', { state: { amount: 1999, eventName: '5 Passes Bundle' } })}
